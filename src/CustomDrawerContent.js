                ...
                <ScrollView refreshControl={
                    ...
                    >
                        <Text style={styles.text}>
                            <FontAwesome5 name="home" size={24} color={"#222222"} />  Trang Chủ</Text>
                    ...
                    >
                        <Text style={styles.text} ><FontAwesome5 name="user" size={24} color={"#222222"} />    <Text style={styles.texts}>Thông Báo</Text></Text>
                    </TouchableOpacity>
                    ...
                    >
                        <Text style={styles.text}><FontAwesome5 name="list-alt" size={24} color={"#222222"} />   <Text style={styles.texts}>Liên Hệ</Text></Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{ marginTop: 25 }}
                        onPress={() => this.props.navigation.navigate('IntroduceDrawer')}
                    >
                        <Text style={styles.text}><FontAwesome5 name="exchange-alt" size={24} color={"#222222"} />   <Text style={styles.texts}>Giới Thiệu</Text></Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{ marginTop: 25 }}
                        onPress={() => this.props.navigation.navigate('IntroduceStart')}
                    >
                        <Text style={styles.text}><FontAwesome5 name="grin-stars" size={24} color={"#222222"} />   <Text style={styles.texts}>Hướng Dẫn</Text></Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{ marginTop: 25 }}
                        onPress={() => this.props.navigation.navigate('Policy')}
                    >
                        <Text style={styles.text}><FontAwesome5 name="balance-scale" size={24} color={"#222222"} />   <Text style={styles.texts}>Chính sách</Text></Text>
                    </TouchableOpacity>
                    {/* <TouchableOpacity
                        style={{ marginTop: 25 }}
                    ...
                    {this.state.email == null ?
                        ...
                        >
                            <Text style={styles.text}><FontAwesome5 name="sign-in-alt" size={24} color={"#222222"} />
                    ...
                    {this.state.email == null ?
                        ...
                        >
                            <Text style={styles.text}><FontAwesome5 name="registered" size={24} color={"#222222"} />
                    ...
                    {this.state.email == null ?
                        ...
                        >
                            <Text style={styles.text}><FontAwesome5 name="lock-open" size={24} color={"#222222"} />
